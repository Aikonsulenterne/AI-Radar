...
export default async function SignalPage({
  ...
  return (
    <>
      ...
      <section className="signal-section" aria-label="Fakta og evidens">
        <h2 className="section-title">
          Fakta <span className="section-tag">Dokumenteret i kilder</span>
        </h2>
      ...
      {signal.analysis ? (
        <section className="signal-section signal-analysis" aria-label="Analyse">
          <h2 className="section-title">
            Analyse <span className="section-tag">Fortolkning</span>
          </h2>
          <p>{signal.analysis}</p>
        </section>
      ) : null}
      ...
      {signal.recommendation ? (
        ...
        >
          <h2 className="section-title">
            Anbefaling <span className="section-tag">Foreslået næste skridt</span>
          </h2>
