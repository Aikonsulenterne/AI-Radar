    ...
    <>
      ...
      <section className="signal-section signal-analysis" aria-label="Hypotese">
        <h2 className="section-title">
          Relevanshypotese <span className="section-tag">Hypotese</span>
        </h2>
      ...
      <section className="signal-section" aria-label="Ekstern evidens">
        <h2 className="section-title">
          Ekstern evidens <span className="section-tag">Dokumenteret</span>
        </h2>
